resource "signalfx_single_value_chart" "org_hosts_current" {
  color_by                = "Metric"
...
resource "signalfx_single_value_chart" "org_containers_current" {
  color_by                = "Metric"
  is_timestamp_hidden     = true
  max_delay               = 0
  max_precision           = 0
...
resource "signalfx_single_value_chart" "org_custom_metrics_current" {
  color_by                = "Metric"
  is_timestamp_hidden     = true
  max_delay               = 0
  max_precision           = 0
...
resource "signalfx_time_chart" "org_hosts_limit" {
...
resource "signalfx_time_chart" "org_containers_limit" {
  axes_include_zero  = false
  axes_precision     = 0
  color_by           = "Metric"
  disable_sampling   = false
...
resource "signalfx_time_chart" "org_custom_metrics_limit" {
  axes_include_zero  = false
  axes_precision     = 0
  color_by           = "Metric"
  disable_sampling   = false
...
resource "signalfx_time_chart" "org_containers_ratio" {
  axes_include_zero  = false
  axes_precision     = 0
  color_by           = "Metric"
  disable_sampling   = false
...
resource "signalfx_time_chart" "org_custom_metrics_ratio" {
  axes_include_zero  = false
  axes_precision     = 0
  color_by           = "Metric"
  disable_sampling   = false
...
resource "signalfx_dashboard" "org_child" {
